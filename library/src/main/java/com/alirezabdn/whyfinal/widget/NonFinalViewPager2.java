...
public class NonFinalViewPager2 extends ViewGroup {
    ...
    public NonFinalViewPager2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public NonFinalViewPager2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageForward =
                new AccessibilityViewCommand() {
                    ...
                    public boolean perform(@NonNull View view,
                        ...
                        NonFinalViewPager2 viewPager = (NonFinalViewPager2) view;
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(NonFinalViewPager2.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(NonFinalViewPager2.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(NonFinalViewPager2.this);
