...
/**
 * Translates {@link RecyclerView.OnScrollListener} events to {@link NonFinalViewPager2.OnPageChangeCallback} events
 * for {@link NonFinalViewPager2}. As part of this process, it keeps track of the current scroll position
 * relative to the pages and exposes this position via ({@link #getRelativeScrollPosition()}.
 */
class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    /**
     * @hide
     */
    @Retention(SOURCE)
    ...
    private NonFinalViewPager2.OnPageChangeCallback mCallback;
    private final @NonNull
    NonFinalViewPager2 mViewPager;
    private final @NonNull
    ...
    int mAdapterState;
    private @NonFinalViewPager2.ScrollState
    int mScrollState;
    ...
    ScrollEventAdapter(@NonNull NonFinalViewPager2 viewPager) {
    ...
    void setOnPageChangeCallback(NonFinalViewPager2.OnPageChangeCallback callback) {
        mCallback = callback;
    }
     ...
     * {@link NonFinalViewPager2#endFakeDrag()} is called.
     */
     ...
     * the ViewPager is settling towards its {@link NonFinalViewPager2#getCurrentItem() current item}, or
    ...
    private void dispatchStateChanged(@NonFinalViewPager2.ScrollState int state) {
