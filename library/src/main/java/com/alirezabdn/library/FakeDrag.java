...
/**
 * Provides fake dragging functionality to {@link NonFinalViewPager2}.
 */
class FakeDrag {
    private final NonFinalViewPager2 mViewPager;
    ...
    FakeDrag(NonFinalViewPager2 viewPager, ScrollEventAdapter scrollEventAdapter,
